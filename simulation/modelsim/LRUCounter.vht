...
ENTITY LRUCounterTb IS
END LRUCounterTb;

ARCHITECTURE LRUCounterTb_arch OF LRUCounterTb IS
-- constants               
	CONSTANT half_period : TIME := 5 ns;                                  
	-- signals                                                   
	SIGNAL Clock : STD_LOGIC := '0';
	SIGNAL RData : MemoTableTLRUCounterEntry;
	...
	SIGNAL WData : MemoTableTLRUCounterEntry;
...
BEGIN
	...
	WAuxVector <= LRUCounterToStdLogic(WData);
