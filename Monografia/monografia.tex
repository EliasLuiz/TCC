...
% ---
\titulo{Avaliação em FPGA do mecanismo de memorização de traços dinâmicos}
...
\begin{siglas}
  ...
  \item[JDTM] \textit{Java Dynamic Trace Memoization}% ou Memorização Dinâmica de Traces
