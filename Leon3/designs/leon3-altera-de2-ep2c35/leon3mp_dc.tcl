...
analyze -f VHDL -library work clkgen_de2.vhd
analyze -f VHDL -library work mypackage.vhd
analyze -f VHDL -library work sdctrl16.vhd
analyze -f VHDL -library work apblcd.vhd
