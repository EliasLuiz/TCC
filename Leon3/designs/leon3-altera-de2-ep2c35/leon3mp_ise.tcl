...
project set family "CYCLONEII"
project set device EP2C35
project set speed -6
project set package F672C
...
puts "config.vhd"
xfile add "clkgen_de2.vhd" -lib_vhdl work
puts "clkgen_de2.vhd"
xfile add "mypackage.vhd" -lib_vhdl work
puts "mypackage.vhd"
xfile add "sdctrl16.vhd" -lib_vhdl work
puts "sdctrl16.vhd"
xfile add "apblcd.vhd" -lib_vhdl work
puts "apblcd.vhd"
...
project set "Macro Search Path" "../../netlists/xilinx/CYCLONEII" -process "Translate"
